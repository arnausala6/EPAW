...
<c:choose>
	<c:when test="${requestScope.readOnlyPublic}">
		<div class="post-actions-bar" data-post-id="${post.postId}">
			...
			<span class="act" title="Login required to comment">
